...
<div class="layui-container">
  <div class="layui-row layui-col-space15">
    ...
    <div class="fly-panel">
      <div class="fly-panel-title fly-filter" style="padding: 0; height: 278px;">
        <div class="layui-carousel" id="test1">
          <div>
            <div><img style="height: 278px; width: 100%;" src="/day05/Public/Home/images/slide1.jpg"/></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="fly-panel" style="margin-bottom: 0;">
        ...
        <?php if(is_array($article)): foreach($article as $key=>$v): ?><li>
          ...
          <div class="fly-list-info">
            ...
            <span class="fly-list-nums">
              	...
              	<?php $num = $reply->query("select count(*) count from reply where aid = ".$v['id']); ?>
                <i class="iconfont icon-pinglun1" title="回答"></i> <?php echo ($num[0]['count']); ?>
              </span>
          </div>
          <div class="fly-list-badge">
            <span class="layui-badge layui-bg-red">精帖</span>
      ...
      <div style="text-align: center">
        <div class="laypage-main">
          <a href="<?php echo U('Article/index');?>" class="laypage-next">更多</a>
        </div>
      </div>
    </div>
  </div>
