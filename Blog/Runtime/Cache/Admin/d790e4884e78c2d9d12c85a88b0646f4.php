...
<link href="/day05/Public/Admin/vendors/summernote/dist/summernote.css" rel="stylesheet">
	...
	<div class="container">
		<div class="card" style="padding: 10px 0 0 20px;">
			<button class="btn btn-default btn-icon-text waves-effect" onclick="location.href = '<?php echo U("Mood/index");?>'"><i class="zmdi zmdi-arrow-back"></i> 返回</button>
	            ...
	            <div class="card-body card-padding">
	                ...
	                <div class="form-group">
	                    ...
	                    <div class="col-sm-10">
	                        ...
	                        <div class="fg-line">
	                            <input class="form-control input-sm" id="details" placeholder="introduce" type="text" name="details" value="<?php echo ($data["details"]); ?>">
	                        </div>
	                    </div>
	                </div>
	                <div class="form-group">
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$("#myform").on('submit', function(){
				...
				$.post("<?php echo U('Mood/update');?>",{id,title,details},function(data){
					if (data == 'success') {
						alert('修改成功');
					}else{
						alert('修改失败');
