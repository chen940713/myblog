...
<link href="/day05/Public/Admin/vendors/summernote/dist/summernote.css" rel="stylesheet">
	...
	<div class="container">
		<div class="card" style="padding: 10px 0 0 20px;">
			<button class="btn btn-default btn-icon-text waves-effect" onclick="history.back(-1)"><i class="zmdi zmdi-arrow-back"></i> 返回</button>
	        <form class="form-horizontal" id="myform" role="form" action="<?php echo U('Article/update');?>" method="post">
	            ...
	            <div class="card-body card-padding">
	                ...
	                <div class="form-group">
	                    ...
	                    <div class="col-sm-10">
	                        ...
	                        <div class="fg-line">
	                            <input class="form-control input-sm" id="title" placeholder="title" type="text" name="title" value="<?php echo ($data["title"]); ?>">
	                        </div>
	                    </div>
	                </div>
	                <div class="form-group">
	                    ...
	                    <div class="col-sm-10">
	                        ...
	                        <div class="fg-line">
	                            <input class="form-control input-sm" id="author" placeholder="author" type="text" name="author" value="<?php echo ($data["author"]); ?>">
	                        </div>
	                    </div>
	                </div>
	                <div class="form-group">
	                    ...
	                    <div class="col-sm-10">
	                        ...
	                        <div class="fg-line">
	                            <input class="form-control input-sm" id="intro" placeholder="introduce" type="text" name="intro" value="<?php echo ($data["intro"]); ?>">
	                        </div>
	                    </div>
	                </div>
	                <div class="form-group">
	                    ...
	                    <div class="col-sm-10">
	                        ...
	                        <div class="fg-line">
	                            <input class="form-control input-sm" id="keywords" placeholder="请用逗号分隔" type="text" name="keywords" value="<?php echo ($data["keywords"]); ?>">
	                        </div>
	                    </div>
	                </div>
                    <div class="card-header">
                    ...
                    <div class="card-body card-padding">
                        <div class="html-editor"><?php echo ($data["details"]); ?></div>
                    </div>
	                <div class="form-group">
	                    <div class="col-sm-offset-2 col-sm-10">
	                        <button type="submit" class="btn btn-primary btn-sm waves-effect">修 改</button>
	                    </div>
	                </div>
	            </div>
	        </form>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$("#myform").on('submit', function(){
				...
				$.post("<?php echo U('Article/update');?>",{id,title,author,intro,keywords,details},function(data){
					if (data == 'success') {
						alert('修改成功');
					}else{
						alert('修改失败');
