						...
						<thead>
							<tr>
								...
								<th data-column-id="received" class="text-left" style="">
									<a href="javascript:void(0);" class="column-header-anchor sortable"><span class="text">详情</span><span class="zmdi icon zmdi-expand-more"></span></a>
								</th>
								<th data-column-id="received" class="text-left" style="">
					...
					<div class="row">
						<div class="col-sm-6">
							<ul class="pagination">
								...
								<?php $__FOR_START_1105637542__=1;$__FOR_END_1105637542__=$total+1;for($i=$__FOR_START_1105637542__;$i < $__FOR_END_1105637542__;$i+=1){ ?><li class="page-<?php echo ($i); ?>" aria-disabled="false" aria-selected="true">
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$(".pagination").on('click','li',function(ev){
				...
				$.get("/day05/index.php/Admin/Mood/ajax?p="+page, function(data){
					var html = "";
			...
			$("table").on('click', '.modify', function(ev){
				...
				location.href = "/day05/index.php/Admin/Mood/edit?id="+id;
			})
			$("table").on('click', '.del', function(ev){
				var id = ev.target.dataset.id;
				$.get("/day05/index.php/Admin/Mood/del?id="+id, function(data){
					if (data == "success") {
						alert('删除成功');
						location.reload();
					}
